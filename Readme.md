...
- On the Github page, find the YAML code (at time of writing: https://github.com/hubertjanhickinson/OrconWifiController/blob/main/Wemos%202.0) for the corresponding version of your OrconWifiController.
